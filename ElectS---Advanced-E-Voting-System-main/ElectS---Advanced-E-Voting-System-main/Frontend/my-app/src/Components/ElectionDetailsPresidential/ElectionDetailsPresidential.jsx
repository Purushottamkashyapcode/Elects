...
import './ElectionDetailsPresidential.css';
import { useParams, useNavigate } from 'react-router-dom';
import Swal from 'sweetalert2';
import vote from '../Assests/online-voting.png';
import { useTheme } from '../../Context/ThemeContext';

const ElectionDetailsPresidential = () => {
  ...
  return (
    <div className={`election-details-container ${theme}`}>
      <h2 className={`election-title ${theme}`}>Presidential Election - {election.year}</h2>
...
export default ElectionDetailsPresidential;
